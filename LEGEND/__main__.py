...
PM_START_TEXT = """
Hello *{first}* there, I'm [𓊈𒆜𝙿𝚁𝙸𝙽𝙲𝙴𝚂𝚂𒆜𓊉](https://telegra.ph/file/bf3ded9c4c4b7c345167b.jpg)
...
buttons = [
    [
        InlineKeyboardButton(text="𓊈𒆜INFORMATION𒆜𓊉", callback_data="aboutmanu_"),
    ],
    [
        InlineKeyboardButton(text="𓊈𒆜HELP AND CMANDS𒆜𓊉", callback_data="help_back"),
    ],
    [
        InlineKeyboardButton(
            text="𓊈𒆜ADD PRINCESS TO YOUR GROUP𒆜𓊉",
            url="t.me/The_Princess2_Bot?startgroup=true",
        ),
    ],
]
...
💠➥ /donate: _You can support my creater using this command_😁.
💠➥ /settings: 
...
DONATE_STRING = """Heya,{first} glad to hear you want to donate!
You can donate to the original writer's of the Base code,
Support them  [💠➥DEV💠](t.me/PRINCESS_SUPPORT) [𓊈𒆜𝙿𝚁𝙸𝙽𝙲𝙴𝚂𝚂 𝙱𝚘𝚝𒆜𓊉](t.me/PRINCESS_SUPPORT),"""
...
def LEGEND_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"*➥💠 Hi {first} again!  The name's {dispatcher.bot.first_name} ♐\n\nAs  You I'm a next generational group management bot developed by *@MR_PURUSHOTTAM_M.* "
            f"\n\n 🔥 Join [𓊈𒆜𝙿𝚁𝙸𝙽𝙲𝙴𝚂𝚂 𝚂𝚄𝙿𝙿𝙾𝚁𝚃𒆜𓊉](https://t.me/PRINCESS_SUPPORT) To Keep Yourself Updated About {dispatcher.bot.first_name} 🔥"
            f"\n\n I have the normal GROUP MANAGING functions like flood control, a warning system etc but I mainly have the advanced and handy Antispam system and the SIBYL banning system which safegaurds and helps your group from spammers."
            f"\n\nI Can Manage Your Groups Smoothly, With Some Special Features Of [𓊈𒆜𝙿𝚁𝙸𝙽𝙲𝙴𝚂𝚂𒆜𓊉](https://telegra.ph/file/bfa66b588acedfc8c24ac.jpg)"
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} by joining [𓊈𒆜𝙿𝚁𝙸𝙽𝙲𝙴𝚂𝚂 𝚂𝚄𝙿𝙿𝙾𝚁𝚃𒆜𓊉](https://t.me/PRINCESS_SUPPORT).\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            ...
            f"\n\nSaurce Of The bot Can Be found here [𓊈𒆜PRINCESS BOT𒆜𓊉](http://t.me/PRINCESS_SUPPORT)."
            f"\n\n{dispatcher.bot.first_name}'s source code was rewritten by @Mr_PURUSHOTTAM_M "
        ...
        query.message.edit_text(
            ...
            f"\n💠➲ Always try to keep credits, so \n  This hardwork is done by <b>@Mr_PURUSHOTTAM_M<b> spending many sleepless nights.. So, Respect it."
...
def main():
    ...
    if LEGENDX == 1711642802:
         print (*PRINCESS IS HERE 😉")
    else:
